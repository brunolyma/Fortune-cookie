...
const item = Math.round(Math.random() * 60);
const fortune = [
  ...
  "Muitas das grandes realizações do mundo foram feit…dos e desanimados que continuaram o seu trabalho.",
  ...
  "A adversidade desperta em nós capacidades que, em …unstâncias favoráveis, teriam ficado adormecidas.",
  "Motivação não é sinónimo de transformação, mas um passo em sua direção.",
  "O que empobrece o ser humano, não é a falta de din…mais sim, a falta de fé,motivação e criatividade.",
  ...
  "A nossa vida tem 4 sentidos… Amar, Sofrer, Lutar e…muito, sofra pouco, lute bastante e vença sempre!",
...
const handleClick = () => {
  ...
  message.innerText = fortune[item];
};
